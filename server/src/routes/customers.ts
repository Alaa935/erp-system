...
router.get('/count-today', authorize('admin', 'manager', 'rep'), customersController.countToday);
router.get('/', authorize('admin', 'manager', 'rep'), customersController.list);
router.get('/:id', authorize('admin', 'manager', 'rep'), customersController.getById);
router.post('/', authorize('admin', 'manager', 'rep'), validate(createCustomerSchema), customersController.create);
