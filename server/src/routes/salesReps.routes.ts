...
router.get('/', authorize('admin', 'manager', 'rep'), salesRepsController.list);
router.get('/:id', authorize('admin', 'manager', 'rep'), salesRepsController.getById);
router.get('/:id/inventory', authorize('admin', 'manager', 'rep'), salesRepsController.getInventory);
...
router.delete('/:id', authorize('admin', 'manager'), validate(deleteSalesRepSchema), salesRepsController.remove);
